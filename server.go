...
func sendEmail(form ContactForm, mailUser, mailPass, adminTo string) (string, error) {
    ...
    case "nl":
        ...
        htmlBody = fmt.Sprintf(`<div style="font-family: Arial, sans-serif; padding: 20px;"><h2 style="color: #222;">Hallo %s,</h2><p>Bedankt voor uw contact! We hebben je bericht ontvangen.</p><blockquote style="border-left: 4px solid #e80000ff; margin: 10px 0; padding-left: 10px;">%s</blockquote><p>We nemen zo snel mogelijk contact met je op.</p><p style="font-size: 12px; color: #888;">Dit is een geautomatiseerd bericht. Gelieve niet te antwoorden.</p><p style="font-size: 12px; color: #888;">— Het Eldocam-team</p></div>`, html.EscapeString(form.Name), escapedMsg)
        successText = "Je bericht is aangekomen. Je kunt deze pagina sluiten."
    case "en":
        subject = "Auto reply"
        htmlBody = fmt.Sprintf(`<div style="font-family: Arial, sans-serif; padding: 20px;"><h2 style="color: #222;">Hello %s,</h2><p>Thank you for contacting us! We have received your message.</p><blockquote style="border-left: 4px solid #e80000ff; margin: 10px 0; padding-left: 10px;">%s</blockquote><p>We will get back to you as soon as possible.</p><p style="font-size: 12px; color: #888;">This is an automated message. Please do not reply.</p><p style="font-size: 12px; color: #888;">— The Eldocam team</p></div>`, html.EscapeString(form.Name), escapedMsg)
        successText = "Your message has been received. You can close this page."
    default:
        subject = "Réponse automatique"
        htmlBody = fmt.Sprintf(`<div style="font-family: Arial, sans-serif; padding: 20px;"><h2 style="color: #222;">Bonjour %s,</h2><p>Merci de nous avoir contactés ! Nous avons bien reçu votre message.</p><blockquote style="border-left: 4px solid #e80000ff; margin: 10px 0; padding-left: 10px;">%s</blockquote><p>Nous reviendrons vers vous dans les plus brefs délais.</p><p style="font-size: 12px; color: #888;">Ceci est un message automatique. Merci de ne pas répondre.</p><p style="font-size: 12px; color: #888;">— L’équipe Eldocam</p></div>`, html.EscapeString(form.Name), escapedMsg)
